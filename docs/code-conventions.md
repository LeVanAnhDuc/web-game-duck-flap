...
> **Phạm vi:** bản sao trong repo `duck-flap`. Bản canon nằm ở gốc workspace `web-game/`.
> **Trạng thái ở repo này:** 🟢 đã áp — xem §8
...
| mines | Next | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | có `views/`+`mains/`; `mains/SettingsSheet` 356 dòng |
| push | Next | ⬜ | ➖ | ⬜ | ⬜ | ⬜ | ⬜ | ⬜ | có `views/`, chưa có `mains/` |
