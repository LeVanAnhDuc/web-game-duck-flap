...
Ai cũng biết Flappy Bird, kể cả người chưa từng chơi. Từ họ dùng: "vỗ cánh", "lách qua
ống", "được mấy điểm", "chết ngay ống đầu".

Đặc thù duy nhất và quan trọng nhất của thể loại: **game phải bắt đầu trong một cú chạm**.
Không menu, không chọn gì. Persona nào phải bấm quá một lần để vào game là đã có phát hiện.

Người chơi cũng mang sẵn một kỳ vọng về **sự công bằng**: va chạm phải nhìn như va chạm.
Chết khi trông như vừa lách qua được là lỗi nặng nhất của thể loại này.
